import type { NflStandingItem, NflTeamItem } from '../nfl-bff-types';
import { nullableString, parseOptionalInt, parseRequiredInt } from './shared';

export interface NflStandingFormValues {
  queryLeague: string;
  querySeason: string;
...
export const EMPTY_NFL_STANDING_FORM: NflStandingFormValues = {
  queryLeague: '1',
  querySeason: '2022',
  queryConference: '',
  standingId: '',
...
export function standingToFormValues(item: NflStandingItem): NflStandingFormValues {
  return {
...
export function applyTeamToStanding(
  values: NflStandingFormValues,
  team: NflTeamItem,
): NflStandingFormValues {
  return {
    ...values,
...
export function validateNflStandingForm(
  values: NflStandingFormValues,
...
export function buildNflStandingBody(values: NflStandingFormValues): NflStandingItem {
  return {
    league: {
