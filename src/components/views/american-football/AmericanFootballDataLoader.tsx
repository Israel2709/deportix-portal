...
import { AmericanFootballCountrySection } from './AmericanFootballCountrySection';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="min-w-0 flex-1">
          {activeStep === 'countries' && <AmericanFootballCountrySection step={1} onDataChanged={onDataChanged} />}
          {activeStep === 'leagues' && <AmericanFootballLeagueSection step={2} onDataChanged={onDataChanged} />}
          {activeStep === 'seasons' && <AmericanFootballSeasonSection step={3} onDataChanged={onDataChanged} />}
          {activeStep === 'teams' && <AmericanFootballTeamSection step={4} onDataChanged={onDataChanged} />}
          {activeStep === 'games' && <AmericanFootballGameSection step={5} onDataChanged={onDataChanged} />}
          {activeStep === 'standings' && <AmericanFootballStandingSection step={6} onDataChanged={onDataChanged} />}
          {activeStep === 'timezone' && <AmericanFootballTimezoneSection step={7} onDataChanged={onDataChanged} />}
        </div>
      </div>
    </div>
  );
