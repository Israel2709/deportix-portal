...
import { nflLeaguePath } from '@/lib/nfl-paths';
...
export function NflLeaguesBrowse() {
  const leaguesRes = useAllLeagues('nfl');
  ...
  return (
    <section className="space-y-4">
      ...
      <DataSection
        ...
        emptyAction={!query.trim() ? <NflLoaderLink /> : undefined}
      >
