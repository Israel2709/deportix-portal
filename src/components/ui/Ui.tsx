...
const COVERAGE_STYLES: Record<CoverageLevel, { label: string; className: string }> = {
  ...
  partial: { label: 'Partial coverage', className: 'bg-amber-500/15 text-amber-300 border-amber-500/30' },
  none: { label: 'No data loaded yet', className: 'bg-slate-500/15 text-slate-300 border-slate-500/30' },
};
